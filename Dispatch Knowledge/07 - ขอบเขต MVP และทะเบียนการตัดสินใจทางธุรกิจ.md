...
* **ประเด็นที่ยังไม่ตัดสินใจ (Blocker)**: **BDR-RETURN-002 (หลักฐานบังคับคืนสินค้า) — APPROVED 2026-07-21 Option C (ดูหัวข้อ 15.2) ไม่บล็อกการยอมรับ MVP-12 อีกต่อไป**; BDR-RETURN-007 (ยืนยันคืนสินค้าก่อนมอบหมาย Attempt ถัดไปหรือไม่) — DECIDE_DURING_IMPLEMENTATION / P1; **BDR-RETURN-003 (Reopen จาก CANCELLED ขณะ PENDING_RETURN) — APPROVED 2026-07-20 (ดูหัวข้อ 15.1) ไม่บล็อกอีกต่อไป**; BDR-RETURN-001, 004, 005, 006, 008, 009 — P1/P2 ตามทะเบียน
...
* **ประเด็นที่ยังไม่ตัดสินใจ (Blocker)**: **BDR-OVERRIDE-006 (ริเริ่มและทบทวนโดยคนเดียวกันได้หรือไม่) — APPROVED 2026-07-21 Option B (ดูหัวข้อ 15.2) ไม่บล็อกการยอมรับ MVP-15 อีกต่อไป**; BDR-OVERRIDE-003 ได้รับอนุมัติแล้วเช่นกันตามหัวข้อ 15.2; BDR-OVERRIDE-002, 004, 005, 007, 008, 009 — P1/P2 ตามทะเบียน
...
* **ประเด็นที่ยังไม่ตัดสินใจ (Blocker)**: **BDR-OVERRIDE-003 (ผลเมื่อปฏิเสธ) — APPROVED 2026-07-21 Option C (ดูหัวข้อ 15.2) ไม่บล็อกการยอมรับ MVP-15 อีกต่อไป**; BDR-OVERRIDE-002 (Review Deadline) — DECIDE_DURING_IMPLEMENTATION / P1 (ไม่ใช่ MUST_DECIDE_BEFORE_MVP)
...
* **ความสามารถที่ไม่รวม**: การเปิดเผยแบบไม่ปิดบังโดยไม่มี Formal Investigation, Case Reference และ governance review ตาม BDR-PRIVACY-001 Option B ที่อนุมัติแล้ว
...
* **ประเด็นที่ยังไม่ตัดสินใจ (Blocker)**: BDR-PRIVACY-003, 004, 005, 006, 008 (ระยะเวลาเก็บรักษา) — P1/P2/P3; BDR-EVIDENCE-012 (ตัวชี้วัดความเสี่ยง Evidence Completeness) — P2; **BDR-PRIVACY-001 — APPROVED 2026-07-21 Option B สำหรับกรณีสืบสวนทางการ (ดูหัวข้อ 15.2)**
...
| GATE-02 | P0 Business Decisions | ทุกประเด็น Priority = P0 ได้รับการอนุมัติ เลื่อนออกไป หรือยอมรับเป็นข้อจำกัดชั่วคราวอย่างชัดเจน — **ผ่านแล้ว 2026-07-20** (ทั้ง 9 รายการ APPROVED ดูหัวข้อ 15.1); 4 รายการ MUST_DECIDE_BEFORE_MVP ที่เป็น Priority P1 ได้รับอนุมัติแล้วเมื่อ 2026-07-21 (ดูหัวข้อ 15.2) | **Business Gate** |
...
## 15.2 Approved P1 MUST_DECIDE_BEFORE_MVP Decisions (2026-07-21)

Product Owner / User อนุมัติ Priority P1 ทั้ง 4 รายการที่มี Decision Timing = MUST_DECIDE_BEFORE_MVP แล้วเมื่อ 2026-07-21 รายการเหล่านี้ไม่ใช่ P0 และไม่เคยบล็อกการเริ่ม Technical Architecture ของ MVP ทั้งระบบ แต่ต้องปิดก่อนการยอมรับ Feature Group ที่เกี่ยวข้อง ผลอนุมัตินี้ไม่เปิด P0 Decisions กลับมาพิจารณาใหม่ ไม่เพิ่ม Role ใหม่ ไม่เพิ่ม Main Task Status ใหม่ และไม่เลือก technical implementation ใด

| Decision ID | Selected option | Approved policy summary | Approved by | Approval date | Synchronization targets |
| --- | --- | --- | --- | --- | --- |
| BDR-RETURN-002 | Option C | Core Return Record เป็นข้อบังคับก่อน Admin ยืนยัน RETURN_CONFIRMED และ additional evidence เป็นข้อบังคับเมื่อมี Risk Trigger; BDR-RETURN-007 และ BDR-RETURN-009 ยังเปิด | Product Owner / User | 2026-07-21 | Topic 5, Topic 6, Topic 7, Topic 9, Topic 10 |
| BDR-OVERRIDE-003 | Option C | Reject ของ Emergency Override เป็น Review Finding และต้องเลือก Controlled Action แยกตามข้อเท็จจริงและความรุนแรง โดยไม่เปลี่ยน Main Task Status อัตโนมัติ | Product Owner / User | 2026-07-21 | Topic 3, Topic 4, Topic 6, Topic 7, Topic 10 |
| BDR-OVERRIDE-006 | Option B | ผู้ริเริ่มและผู้ทบทวน Emergency Override ต้องต่างบุคคลตามปกติ; same-person review อนุญาตเฉพาะ Emergency Continuity พร้อม compensating controls | Product Owner / User | 2026-07-21 | Topic 3, Topic 6, Topic 7, Topic 10 |
| BDR-PRIVACY-001 | Option B | Unmasked sensitive-data access อนุญาตเฉพาะ Formal Investigation ที่มี Case Reference และ case-by-case Security/Privacy Review ภายใต้นโยบายที่ Product Owner / User อนุมัติ | Product Owner / User | 2026-07-21 | Topic 3, Topic 5, Topic 6, Topic 7, Topic 9, Topic 10 |

## 15.3 Approved P2 Assignment Decisions (2026-07-23)

Product Owner / User อนุมัติ Priority P2 ทั้ง 5 รายการในกลุ่ม C: Assignment และบุคลากร (BDR-ASSIGN-001 ถึง BDR-ASSIGN-005) แล้วเมื่อ 2026-07-23 ก่อนเริ่มพัฒนา MVP-04 (Delivery Task Assignment) รายการเหล่านี้ไม่ใช่ P0/P1 และไม่เคยบล็อกการเริ่ม Technical Architecture ของ MVP อื่น แต่มีผลโดยตรงต่อขอบเขตของ MVP-04 ผลอนุมัตินี้ไม่เปิด P0/P1 Decisions ที่อนุมัติแล้วกลับมาพิจารณาใหม่ ไม่เพิ่ม Role ใหม่ ไม่เพิ่ม Main Task Status ใหม่ และไม่เลือก technical implementation ใด — สอดคล้องกับกลไก Reassignment ที่อนุมัติแล้วเดิมทั้งหมด

**Decision owner ของทั้ง 5 รายการ**: ตามที่ระบุในแต่ละแถวของตารางกลุ่ม C (หัวข้อ 15 ด้านบน) **Approved by**: Product Owner / User **Approval date**: 2026-07-23 (ทั้ง 5 รายการ)

| Decision ID | Selected option | Approved policy summary | Approved by | Approval date | Synchronization targets |
| --- | --- | --- | --- | --- | --- |
| BDR-ASSIGN-001 | — | หนึ่ง Task มีผู้รับผิดชอบหลัก (Primary Assignee) เพียงหนึ่งคนเสมอ อาจมีพนักงานที่ร่วมปฏิบัติงาน (Supporting Employee) ได้ตั้งแต่ศูนย์คนขึ้นไป โดยพนักงานที่ร่วมปฏิบัติงานต้องไม่ซ้ำกัน และผู้รับผิดชอบหลักต้องไม่ปรากฏซ้ำเป็นพนักงานที่ร่วมปฏิบัติงานในรายการเดียวกัน | Product Owner / User | 2026-07-23 | Topic 3, Topic 6, Topic 7 |
| BDR-ASSIGN-002 | — | พนักงานที่ร่วมปฏิบัติงานเป็นข้อมูลประกอบ (Informational Only) ใน MVP-04 เท่านั้น ไม่ได้รับสิทธิ์เข้าถึง Task สิทธิ์อัปโหลดหลักฐาน หรืออำนาจกระทำการส่งมอบใด ๆ ไม่มีการมอบอำนาจแบบ Proxy, Shared-login, Delegated หรือสิทธิ์ชั่วคราวใด ๆ | Product Owner / User | 2026-07-23 | Topic 3, Topic 6, Topic 7 |
| BDR-ASSIGN-003 | — | ความไม่พร้อมของผู้รับผิดชอบหลักต้องแก้ไขด้วยการเปลี่ยนตัวผู้รับผิดชอบ (Formal Reassignment) เท่านั้น ห้าม Hidden Substitution, Shared-login, Proxy Execution หรือสิทธิ์ชั่วคราวที่ไม่บันทึก ทุก Reassignment ต้องรักษาประวัติที่ไม่เปลี่ยนแปลงและหลักฐาน Audit ครบถ้วน | Product Owner / User | 2026-07-23 | Topic 3, Topic 6, Topic 7 |
| BDR-ASSIGN-004 | — | หนึ่งพนักงานภายในสามารถถือ Task ที่ Active พร้อมกันได้มากกว่าหนึ่งรายการ จำนวนปริมาณงาน (Workload Count) ทำหน้าที่เป็นคำเตือนเท่านั้น ไม่บล็อกการมอบหมาย และสถานะปริมาณงาน Active ใช้โมเดลสถานะกลางที่มีอำนาจ (Centralized Authoritative Status Model) | Product Owner / User | 2026-07-23 | Topic 3, Topic 4, Topic 6, Topic 7 |
| BDR-ASSIGN-005 | — | บันทึกเหตุผลของการมอบหมายครั้งแรก (Initial Assignment Note) เป็นทางเลือก (Optional) ทุกกรณีของการเปลี่ยนตัวผู้รับผิดชอบ (Reassignment) ต้องมีเหตุผลที่ผ่านการ Normalize และไม่ว่างเปล่าเสมอ (Mandatory Non-empty Reason) และเหตุผลนั้นถูกเก็บรักษาในประวัติอย่างถาวร | Product Owner / User | 2026-07-23 | Topic 3, Topic 6, Topic 7 |

> [!note] Traceability
> รายละเอียดการนำไปปฏิบัติ (Implementation) ของทั้ง 5 รายการอยู่ใน `docs/CTO_SUMMARY_MVP_04.md` หัวข้อ 4 (Approved Assignment Decisions) ซึ่งอ้างอิง BR-ASSIGN-001, BR-ASSIGN-004, BR-ASSIGN-005 เอกสารฉบับนี้ (Topic 7) คือบันทึกการอนุมัติที่มีอำนาจ (Authoritative Approval Record) ของ BDR-ASSIGN-001 ถึง BDR-ASSIGN-005 — CTO Summary เป็นเพียงบันทึกการนำไปปฏิบัติทางเทคนิค ไม่ใช่บันทึกการอนุมัติทางธุรกิจคู่ขนาน
>
> **ขอบเขตของ BDR-ASSIGN-003**: อนุมัตินี้ครอบคลุมเฉพาะกลไกการเข้าถึง Task ของพนักงานทดแทนชั่วคราว (ใช้ Reassignment ที่อนุมัติแล้วแทนการสร้างสิทธิ์ใหม่) ไม่ครอบคลุมนโยบายปฏิบัติการที่กว้างกว่านี้เกี่ยวกับพนักงานทดแทนชั่วคราว (เช่น เกณฑ์การเลือกพนักงานทดแทน หรือกระบวนการแจ้งเตือนเมื่อพนักงานประจำลาป่วยกะทันหัน) ซึ่งยังคงเป็นประเด็นเปิดแยกต่างหากที่ยังไม่ได้รับการตัดสินใจในหัวข้อนี้
...
| ลำดับ | Decision ID | หมวด | ประเด็นการตัดสินใจ | สถานะปัจจุบัน | Priority | ผลกระทบ | เหตุผลที่ต้องตัดสินใจ | ผลหากยังไม่ตัดสินใจ | ผู้อนุมัติ/เจ้าของ | จุดที่ต้องได้คำตอบ | แนวทางปัจจุบัน | Source Topic | Related Rule IDs | หมายเหตุ |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 15 | BDR-ASSIGN-001 | Assignment | พนักงานที่ร่วมปฏิบัติงาน (Supporting/Co-traveling Employee) ควรถูกบันทึกในระบบอย่างไร | **APPROVED** | P2 | PERMISSION, UX | (แก้ไขแล้ว) หนึ่ง Task มีผู้รับผิดชอบหลัก (Primary Assignee) เพียงหนึ่งคนเสมอ อาจมีพนักงานที่ร่วมปฏิบัติงาน (Supporting Employee) ได้ตั้งแต่ศูนย์คนขึ้นไปโดยต้องไม่ซ้ำกัน และผู้รับผิดชอบหลักต้องไม่ปรากฏซ้ำเป็นพนักงานที่ร่วมปฏิบัติงาน | (แก้ไขแล้ว) มีแนวทางบันทึกผู้ร่วมปฏิบัติงานที่ชัดเจนแล้วสำหรับ UX ของ MVP-04 | UX/Product Design (ร่วม Delivery Operations) | ก่อนยอมรับ MVP-04 | **Approved 2026-07-23 — ดู §15.3** | Topic 3 §13.4 | BR-ASSIGN-005 | ไม่กระทบหลักการหนึ่ง Task หนึ่งผู้รับผิดชอบซึ่งอนุมัติแล้ว |
| 16 | BDR-ASSIGN-002 | Assignment | พนักงานที่ร่วมปฏิบัติงานสามารถให้ข้อมูลหรือหลักฐานได้หรือไม่ | **APPROVED** | P2 | PERMISSION, EVIDENCE | (แก้ไขแล้ว) พนักงานที่ร่วมปฏิบัติงานเป็นข้อมูลประกอบ (Informational Only) ใน MVP-04 เท่านั้น ไม่ได้รับสิทธิ์เข้าถึง Task สิทธิ์อัปโหลดหลักฐาน หรืออำนาจกระทำการส่งมอบใด ๆ ไม่มี Proxy, Shared-login, Delegated หรือสิทธิ์ชั่วคราวใด ๆ | (แก้ไขแล้ว) สิทธิ์อัปโหลดหลักฐานจริงชัดเจนแล้วว่าเป็นของผู้รับผิดชอบหลักเท่านั้น | Delivery Operations | ก่อนยอมรับ MVP-04 | **Approved 2026-07-23 — ดู §15.3** | Topic 3 §13.4 | BR-ASSIGN-005 | คู่กับ BDR-ASSIGN-001 |
| 17 | BDR-ASSIGN-003 | Assignment | พนักงานทดแทนชั่วคราวควรได้รับสิทธิ์เข้าถึง Task อย่างไร | **APPROVED** | P2 | PERMISSION, OPERATIONS | (แก้ไขแล้ว) ความไม่พร้อมของผู้รับผิดชอบหลักต้องแก้ไขด้วยการเปลี่ยนตัวผู้รับผิดชอบ (Formal Reassignment) ที่อนุมัติแล้วเท่านั้น ห้าม Hidden Substitution, Shared-login, Proxy Execution หรือสิทธิ์ชั่วคราวที่ไม่บันทึก; ทุก Reassignment ต้องรักษาประวัติที่ไม่เปลี่ยนแปลงและหลักฐาน Audit ครบถ้วน | (แก้ไขแล้ว) กลไก Reassignment ที่อนุมัติแล้วรองรับกรณีพนักงานประจำไม่พร้อมได้โดยไม่ต้องสร้างสิทธิ์เข้าถึงใหม่ | Delivery Operations (ร่วม Super Admin Governance) | ก่อนยอมรับ MVP-01/MVP-04 | **Approved 2026-07-23 — ดู §15.3** | Topic 3 §26 | (ไม่มี Rule ID เฉพาะ — future) | ทับซ้อนกับ Reopen/Reassignment ที่อนุมัติแล้วบางส่วน; อนุมัตินี้ครอบคลุมเฉพาะกลไกการเข้าถึง Task ของพนักงานทดแทนชั่วคราว (ใช้ Reassignment แทนการสร้างสิทธิ์ใหม่) — ไม่ครอบคลุมนโยบายปฏิบัติการที่กว้างกว่านี้เกี่ยวกับพนักงานทดแทนชั่วคราว ซึ่งยังเป็นประเด็นเปิดแยกต่างหาก |
| 18 | BDR-ASSIGN-004 | Assignment | หนึ่งพนักงานสามารถถือ Task ที่ Active พร้อมกันได้มากกว่าหนึ่งรายการหรือไม่ | **APPROVED** | P2 | PERMISSION, OPERATIONS | (แก้ไขแล้ว) หนึ่งพนักงานภายในถือ Task ที่ Active พร้อมกันได้มากกว่าหนึ่งรายการ; จำนวนปริมาณงาน (Workload Count) แสดงเป็นคำเตือนเท่านั้น ไม่บล็อกการมอบหมาย; สถานะปริมาณงาน Active ใช้โมเดลสถานะกลางที่มีอำนาจ (Centralized Authoritative Status Model) | (แก้ไขแล้ว) ระบบไม่บล็อกการมอบหมายซ้อนตามที่อนุมัติ — แสดงเพียงคำเตือนประกอบการตัดสินใจ | Delivery Operations | ก่อนยอมรับ MVP-04 | **Approved 2026-07-23 — ดู §15.3** | Topic 3 §13.3 | BR-ASSIGN-001 | ไม่กระทบกฎหนึ่ง Task หนึ่งผู้รับผิดชอบ (อนุมัติแล้ว) |
| 19 | BDR-ASSIGN-005 | Assignment | การเปลี่ยนตัวผู้รับผิดชอบ (Reassignment) ทุกกรณีต้องมีเหตุผลบังคับหรือไม่ | **APPROVED** | P2 | PERMISSION, GOVERNANCE | (แก้ไขแล้ว) บันทึกเหตุผลของการมอบหมายครั้งแรกเป็นทางเลือก (Optional) ส่วนทุกกรณีของ Reassignment ต้องมีเหตุผลที่ผ่านการ Normalize และไม่ว่างเปล่าเสมอ (Mandatory Non-empty Reason) ไม่มีข้อยกเว้น | (แก้ไขแล้ว) ข้อกำหนดเหตุผลระหว่างการมอบหมายครั้งแรกกับ Reassignment สอดคล้องกันแล้ว และเหตุผล Reassignment ถูกเก็บรักษาในประวัติอย่างถาวรตามที่อนุมัติ | Admin Operations | ก่อนยอมรับ MVP-04 | **Approved 2026-07-23 — ดู §15.3** | Topic 3 §13.5 | BR-ASSIGN-004 | Reassignment กรณีข้อยกเว้น (Reopen) มีเหตุผลบังคับอยู่แล้ว |
...
| 48 | BDR-RETURN-002 | Returned Goods | ข้อกำหนดหลักฐานที่บังคับสำหรับการคืนสินค้า | **APPROVED** | P1 | RETURNED_GOODS, EVIDENCE | (แก้ไขแล้ว) Core Return Record เป็นข้อบังคับก่อน Admin ยืนยัน RETURN_CONFIRMED และ evidence เพิ่มเติมบังคับเมื่อมี Risk Trigger | (แก้ไขแล้ว) Admin มีเกณฑ์ยืนยันรับคืนที่สอดคล้องกันตาม Option C | Product Owner / User (ร่วม Admin Operations) | ก่อนยอมรับ MVP-12 | **Approved 2026-07-21 — Option C, ดู §15.2** | Topic 5 §39 กลุ่ม H | BR-RETURN-006 | BDR-RETURN-007 และ BDR-RETURN-009 ยังไม่ถูกตัดสินโดย approval นี้ |
...
| 62 | BDR-OVERRIDE-003 | Emergency Override | ผลที่ตามมาเมื่อ Super Admin ปฏิเสธ (Reject) การใช้ Emergency Override คืออะไร | **APPROVED** | P1 | EMERGENCY_OVERRIDE, STATUS_TRANSITION, GOVERNANCE | (แก้ไขแล้ว) Reject ถูกบันทึกเป็น Review Finding และต้องเลือก Controlled Action แยกตามข้อเท็จจริงและความรุนแรง | (แก้ไขแล้ว) Reject ไม่ลบ/เขียนทับ Override เดิม ไม่เปลี่ยน Main Task Status อัตโนมัติ และไม่ Reopen/Cancel อัตโนมัติ | Product Owner / User (ร่วม Super Admin Governance) | ก่อนยอมรับ MVP-15 | **Approved 2026-07-21 — Option C, ดู §15.2** | Topic 3 §27; Topic 4 §32 | BR-REVIEW-004, BR-OVERRIDE-010 | Reopen, correction และ escalation ยังคงเป็น controlled actions แยก |
...
| 65 | BDR-OVERRIDE-006 | Emergency Override | หนึ่งบุคคลสามารถทั้งริเริ่มและทบทวน Override เดียวกันได้หรือไม่ (นอกเหนือจากที่กำหนดไว้แล้วว่า Admin ริเริ่มและ Super Admin ทบทวนเสมอ) | **APPROVED** | P1 | EMERGENCY_OVERRIDE, PERMISSION, GOVERNANCE | (แก้ไขแล้ว) ผู้ริเริ่มและผู้ทบทวนต้องต่างบุคคลตามปกติ แต่อนุญาต same-person review เฉพาะ Emergency Continuity | (แก้ไขแล้ว) Emergency Continuity ต้องบันทึกเหตุผล ผู้ทบทวนอื่นไม่พร้อม actor identity timestamp marker Timeline และ Audit Log | Super Admin Governance (ร่วม Security/Privacy Review) | ก่อนยอมรับ MVP-15 | **Approved 2026-07-21 — Option B, ดู §15.2** | Topic 6 §40 กลุ่ม J | BR-REVIEW-006 | ไม่เพิ่ม Role ใหม่ และต้องมี governance follow-up โดย authorized person คนอื่นเมื่อพร้อม |
...
| 71 | BDR-PRIVACY-001 | Sensitive Data | กระบวนการเปิดเผยข้อมูลแบบไม่ปิดบังระหว่างการสืบสวนอย่างเป็นทางการ | **APPROVED** | P1 | PRIVACY, SECURITY, GOVERNANCE | (แก้ไขแล้ว) Unmasked access อนุญาตเฉพาะ Formal Investigation ที่มี Case Reference และ case-by-case governance review ภายใต้นโยบายที่ Product Owner / User อนุมัติ | (แก้ไขแล้ว) มีเส้นทางอนุมัติ/ปฏิเสธที่บันทึก reason, necessity, scope, recipients, duration, export restriction และ Audit Log | Security/Privacy Review (ร่วม Product Owner) | ก่อนยอมรับ MVP-18/MVP-19 | **Approved 2026-07-21 — Option B, ดู §15.2** | Topic 3 §27; Topic 5 §39 กลุ่ม E | BR-SECURITY-009 | Security/Privacy Review เป็น governance review function ไม่ใช่ Dispatch application Role ใหม่ |
...
| 15 | ผลที่ตามมาเมื่อ Override ถูกปฏิเสธ | BDR-OVERRIDE-003 | **ไม่ใช่ P0 แต่ใกล้เคียง** — ได้รับอนุมัติแล้วเมื่อ 2026-07-21 เป็น Option C | MVP-15 | Reject เป็น Review Finding และต้องเลือก Controlled Action แยกตามข้อเท็จจริงและความรุนแรง | Product Owner / User | APPROVED 2026-07-21 |
| 16 | ผู้ริเริ่มและผู้ทบทวน Override เป็นคนเดียวกันได้หรือไม่ | BDR-OVERRIDE-006 | **ไม่ใช่ P0** — ได้รับอนุมัติแล้วเมื่อ 2026-07-21 เป็น Option B | MVP-15 | ต้องต่างบุคคลตามปกติ และ same-person review ทำได้เฉพาะ Emergency Continuity พร้อม compensating controls | Product Owner / User | APPROVED 2026-07-21 |
...
| 19 | อำนาจเปิดเผยข้อมูลแบบไม่ปิดบังระหว่างสืบสวนทางการ | BDR-PRIVACY-001 | **ไม่ใช่ P0 แต่มีความเร่งด่วนสูง (P1)** — ได้รับอนุมัติแล้วเมื่อ 2026-07-21 เป็น Option B | MVP-18, MVP-19 | อนุญาตเฉพาะ Formal Investigation ที่มี Case Reference และ case-by-case Security/Privacy Review ภายใต้นโยบายที่ Product Owner / User อนุมัติ | Product Owner / User | APPROVED 2026-07-21 |
...
>
> **ปรับปรุง 2026-07-20**: ทั้ง 9 Decision ID ข้างต้นได้รับการอนุมัติจาก Product Owner / User แล้ว (ดูบันทึกการอนุมัติแบบเต็มในหัวข้อ [15.1](#151-approved-p0-decisions-2026-07-20)) P0 Blocker ทั้งหมดของ MVP ได้รับการปลดล็อกแล้ว Technical Architecture ของ Feature Group ที่เกี่ยวข้อง (MVP-02, MVP-03, MVP-07, MVP-10, MVP-13, MVP-16) อาจเริ่มได้หลัง Knowledge Synchronization เสร็จสมบูรณ์ **ปรับปรุง 2026-07-21**: 4 รายการ MUST_DECIDE_BEFORE_MVP ที่เป็น Priority P1 ได้รับการอนุมัติแล้วเช่นกัน (BDR-RETURN-002, BDR-OVERRIDE-003, BDR-OVERRIDE-006, BDR-PRIVACY-001 — ดูหัวข้อ [15.2](#152-approved-p1-must_decide_before_mvp-decisions-2026-07-21)) จึงไม่บล็อกการยอมรับ Feature Group ที่เกี่ยวข้องอีกต่อไป
...
| 9 | ฝ่ายบริหารขอข้อมูลแบบไม่ปิดบังระหว่างการสืบสวน | MUST_DECIDE_BEFORE_MVP (BDR-PRIVACY-001) | **APPROVED 2026-07-21 (Option B — ดูหัวข้อ 15.2)** | P1 | MVP-18, MVP-19 | **ได้ภายใต้นโยบายที่อนุมัติ** — ต้องเป็น Formal Investigation มี Case Reference และ case-by-case governance review | Approved — Product Owner / User (2026-07-21) | Topic 3, Topic 5, Topic 6 | อนุญาตแบบจำกัด — normal access ยัง masked/restricted |
...
### 28.1 สรุปจำนวนตาม Decision Status (จากทะเบียน 93 รายการ) — ปรับปรุง 2026-07-21

| Decision Status | จำนวน (ก่อน 2026-07-20) | จำนวน (หลัง 2026-07-20) |
| --- | --- | --- |
| APPROVED (ในทะเบียน) | 0 | **13** — 9 รายการ P0 อนุมัติ 2026-07-20 ดูหัวข้อ 15.1 และ 4 รายการ P1 MUST_DECIDE_BEFORE_MVP อนุมัติ 2026-07-21 ดูหัวข้อ 15.2 |
| MUST_DECIDE_BEFORE_MVP | 13 | **0** — ไม่มีรายการค้างหลังการอนุมัติ P1 เมื่อ 2026-07-21 |
...
> [!note]
> **ปรับปรุง 2026-07-21**: จำนวน P0 (Priority) = 9 รายการยังคงเดิม และมี Decision Status = APPROVED ครบทั้ง 9 รายการแล้ว (ดูหัวข้อ 15.1) รายการ MUST_DECIDE_BEFORE_MVP ที่เป็น Priority P1 อีก 4 รายการ (BDR-RETURN-002, BDR-OVERRIDE-003, BDR-OVERRIDE-006, BDR-PRIVACY-001) ได้รับการอนุมัติแล้วเช่นกัน (ดูหัวข้อ 15.2) จึงเหลือรายการ MUST_DECIDE_BEFORE_MVP ค้างอยู่ = 0 ในทางกลับกัน BDR-STATE-001 มี Priority เพียง P3 แต่มี Decision Status เป็น REJECTED_OR_OUT_OF_SCOPE ซึ่งสาธิตว่า Priority ต่ำไม่ได้แปลว่าประเด็นนั้นยังคง "เปิด" อยู่เสมอ — บางประเด็นอาจถูกปิดด้วยการปฏิเสธ ไม่ใช่การอนุมัติ

### 28.3 สถานะความพร้อมของ MVP Feature Group — ปรับปรุง 2026-07-21
...
### 28.4 ข้อสรุป — ปรับปรุง 2026-07-21
...
* **MVP ยังไม่ได้ปลอดจากประเด็นทางธุรกิจทั้งหมด**: รายการ MUST_DECIDE_BEFORE_MVP ทั้ง 13 รายการได้รับการอนุมัติแล้ว แต่ยังมีรายการ DECIDE_DURING_IMPLEMENTATION, POLICY_REVIEW_REQUIRED, TECHNICAL_DECISION และ Phase 2 อีกจำนวนมากที่ยังคงอยู่ในทะเบียน
* ก่อน 2026-07-20 ไม่มีประเด็นใดในทะเบียนถูกจัดเป็น APPROVED **นับจาก 2026-07-21 มี 13 รายการที่ APPROVED** (9 รายการ Priority P0 และ 4 รายการ Priority P1) มีเพียง 1 รายการ (BDR-STATE-001) ที่จัดเป็น REJECTED_OR_OUT_OF_SCOPE เนื่องจากขัดกับโมเดล Main Task Status ที่ล็อกไว้แล้วโดยตรง ไม่มีรายการใดเป็น SUPERSEDED
