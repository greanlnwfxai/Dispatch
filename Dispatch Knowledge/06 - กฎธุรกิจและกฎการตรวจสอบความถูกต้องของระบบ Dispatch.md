...
> [!important] Source of Truth — Topic 6 กับ Topic 7 (v0.2 Synchronization Note)
...
| BR-PREP-008 | อำนาจที่แน่นอนของการแก้ไขข้อมูลการเตรียมสินค้าหลัง IN_TRANSIT (Admin เองหรือจำกัดเฉพาะ Super Admin) ยังไม่ได้ข้อสรุป | ADVISORY | เปิด — ดู [[07 - ขอบเขต MVP และทะเบียนการตัดสินใจทางธุรกิจ]] BDR-PREP-001, BDR-PREP-004 |
...
| BR-RECIPIENT-007 | ฟิลด์ข้อมูลผู้รับสินค้าที่มีสิทธิ์ใช้ Correction Action ได้อย่างชัดเจนยังไม่ได้ข้อสรุป | ADVISORY | เปิด — ดู [[07 - ขอบเขต MVP และทะเบียนการตัดสินใจทางธุรกิจ]] BDR-CORRECTION-001 |
...
| BR-EXTERNAL-009 | ข้อกำหนดขั้นต่ำที่แน่นอนของหลักฐานผู้ส่งสินค้าภายนอกยังไม่ได้ข้อสรุป | ADVISORY | เปิด — ดู [[07 - ขอบเขต MVP และทะเบียนการตัดสินใจทางธุรกิจ]] BDR-EXTERNAL-001 |
...
สแนปช็อตต่อไปนี้คัดลอกมาจาก [[07 - ขอบเขต MVP และทะเบียนการตัดสินใจทางธุรกิจ]] หัวข้อ 28 ณ วันที่ 2026-07-19 **นี่คือภาพนิ่งเพื่อการประสานเท่านั้น ไม่ใช่แหล่งอ้างอิงหลัก** หากเวอร์ชันในอนาคตของ Topic 7 มีค่าต่างจากนี้ ให้ยึด Topic 7 เป็นหลักเสมอ
...
| REJECTED_OR_OUT_OF_SCOPE | 1 |
| APPROVED (ในทะเบียน) | 0 |
| SUPERSEDED | 0 |
| **รวม** | **93** |
